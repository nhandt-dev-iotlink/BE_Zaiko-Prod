...
public class RouteController {
    ...
    @GetMapping(value = "/api/route", produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<ResultBean> getRoute() {

        try {
            List<RouteDTO> route = routeService.getAll();
            ResultBean successResult = new ResultBean(route, Constants.STATUS_OK, Constants.MESSAGE_OK);
